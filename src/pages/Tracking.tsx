    ...
    <div className="min-h-screen bg-slate-900 text-white">
      ...
      {isLoading ? (
        ...
        <div className="flex flex-col items-center justify-center min-h-screen pt-20 gap-12">
          {/* Project 1 Button with wave */}
          <div className="relative w-[700px] max-w-[95vw] text-white bg-sky-500/80 backdrop-blur-sm hover:bg-sky-400/90 rounded-2xl shadow-xl overflow-hidden transition-all duration-300 transform hover:scale-105">
            {/* Wave background */}
            <div
            ...
            >
              <div className="relative w-[200%] h-full animate-waveMotion">
                {[...Array(2)].map((_, i) => (
                  <svg
                    key={i}
                    className={`absolute top-0 left-[${i * 100}%] w-full h-full`}
