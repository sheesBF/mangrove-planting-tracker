/*
  # Add planting plan data for MozBlue project

  1. New Data
    - Creates project 'MozBlue Project 1'
    - Creates three phases
    - Adds monthly planting targets from Nov 2024 to Dec 2026
      - Phase 1: 400 trees (0.35 ha) per month
      - Phase 2: 500 trees (0.42 ha) per month
      - Phase 3: 350 trees (0.28 ha) per month
*/
...
WITH RECURSIVE dates AS (
  SELECT '2024-11-01'::date AS month
  UNION ALL
  SELECT month + interval '1 month'
  FROM dates
  WHERE month < '2026-12-01'::date
),
phase_targets AS (
  SELECT 
    id as phase_id,
